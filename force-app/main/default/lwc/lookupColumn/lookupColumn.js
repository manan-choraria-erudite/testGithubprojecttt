...
export default class LookupColumn extends LightningElement {
    ...
    newRateIconStatefulState;
    discountIconStatefulState;
showHelp = false;
...
                 "<p>to guide you for this psecific field</p><br>";
 ...
 handleNewRateIconStatefulClick()
 {
     console.log('called');
 }
 handleDiscountIconStatefulClick()
 {
          console.log('called');
...
    }
    ...
    showHelpText() {
        this.showHelp = true;
        console.log('show help text true ===>>> '+this.showHelp);
    }

    hideHelpText() {
        this.showHelp = false;
        console.log('show help text false ===>>>> '+this.showHelp);
